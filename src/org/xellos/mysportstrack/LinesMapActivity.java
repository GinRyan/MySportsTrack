 ...
 * @author Liang
 */
public class LinesMapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lines_map);
		...
		points.add(new LatLng(36.140949, 120.45486));
		points.add(new LatLng(36.140751, 120.45546));
		points.add(new LatLng(36.141856, 120.55656));
		points.add(new LatLng(36.141960, 120.65746));
		points.add(new LatLng(36.142867, 120.65877));
		polylineOptions = new PolylineOptions();
		polylineOptions.points(points).color(0xAAFFFF00).width(10);
